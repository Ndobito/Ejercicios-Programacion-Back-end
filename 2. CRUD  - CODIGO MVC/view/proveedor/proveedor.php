    ...
    <table class="table table-striped">
        <thead>
            <tr>
                ...
                <th style="width:120px;">Razon Social</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a href="?c=proveedor&a=Crud&nit=<?php echo $r->nit; ?>">Editar</a></td>
                <td><a onclick="javascript:return confirm('¿Seguro que quiere eliminar este registro?');" href="?c=proveedor&a=Eliminar&nit=<?php echo $r-> nit; ?>">Eliminar</a></td>
            </tr>
            <?php endforeach; ?>
        </tbody>
    </table>