...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(__('Eliminar'), ['action' => 'delete', $infraccion->Id], ['confirm' => __('¿Seguro que quieres borrar el # {0}?', $infraccion->Id), 'class' => 'side-nav-item']) ?>
    ...
    <div class="column-responsive column-80">
        <div class="infraccion form content">
            ...
            <fieldset>
                <legend><?= __('Editar Infraccion') ?></legend>
                <?php
